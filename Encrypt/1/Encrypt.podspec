...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/msh940620/Encrypt"
  ...
  s.source       = { :git => "https://github.com/msh940620/Encrypt.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Encrypt/Encrypt/**/*.{h,m,c}"
